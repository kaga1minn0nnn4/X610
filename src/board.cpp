...
std::array<G4::OpAMP, 3> opamps {
    G4::OpAMP{G4::opamp1, G4::PA1},
    G4::OpAMP{G4::opamp2, G4::PA7},
    G4::OpAMP{G4::opamp3, G4::PB0},
};
...
bool config() {
    ...
    for (auto& opamp : opamps) {
        result &= opamp.config(peripheral::opamp::Mode::pga, peripheral::opamp::Gain::_2_or_minus_1);
    }
